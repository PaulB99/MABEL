...
if __name__ == "__main__":
    ...
    # Load in data 
    test_data, train = TabularDataset.splits(path=data_path, test='datasets/big/test_detection.csv', train='datasets/big/train_detection.csv',format='CSV', fields=fields, skip_header=True)
