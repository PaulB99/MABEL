...
train, valid = TabularDataset.splits(path=data_path, train='datasets/big/train_detection.csv', validation='datasets/big/valid_detection.csv',
...
def train(model,
    ...
    print('Base BERT model training complete in {} seconds'.format(train_time))
    print('Done!')
